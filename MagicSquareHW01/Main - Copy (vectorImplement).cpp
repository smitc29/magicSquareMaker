...
void siameseMethod(int board[32][32], int width, int startRange, int endRange, int row, int col, vector < vector<int> > matrix)
{
...
void main()
{
	...
	else
	{
		...
		if (value % 2 == 1) // Odd square logic
		{
			...
			siameseMethod(board, value, 1, count, row, col, nodes);
